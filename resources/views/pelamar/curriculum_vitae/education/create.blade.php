...
<head>
    ...
    <title>Tambah Pendidikan | CVRE GENERATE</title>
...
@php
    // ==== FLOW & ROUTES (sama seperti halaman lain) ====
    $flow = [
        'personal_detail',
        'experiences',
        'educations',
    ...
    // walaupun ini halaman "create", stepper tetap set ke 'educations'
    ...
    // done/centang: hanya yang ada di $confirmedKeys; halaman current tidak dicentang
...
<div class="flex flex-col items-center justify-center z-10 mt-32 mb-20 w-full px-4">
    <div class="bg-white shadow-lg rounded-lg p-8 mx-auto z-10" style="max-width: 900px; width: 100%;">
        <h2 class="text-2xl text-center text-blue-800 mb-8">Tambah Riwayat Pendidikan</h2>

        <form method="POST" action="{{ route('pelamar.curriculum_vitae.education.addEducation', $curriculumVitaeUser->id) }}" class="grid grid-cols-1 md:grid-cols-2 gap-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" name="school_name" value="{{ old('school_name') }}" placeholder="Nama institusi pendidikan"
            ...
            <div>
                ...
                <input type="text" name="city_education" value="{{ old('city_education') }}" placeholder="Kota pendidikan"
                       class="block w-full rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-2 focus:outline-none h-11 px-3" required>
            ...
            <div>
                ...
                <input type="month" name="start_date" value="{{ old('start_date') }}"
                       class="block w-full rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-2 focus:outline-none h-11 px-3" required>
            ...
            <div>
                ...
                <input type="month" id="end_date" name="end_date" value="{{ old('end_date') }}"
                       class="block w-full rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-2 focus:outline-none h-11 px-3">
            ...
            <div class="md:col-span-2">
                <label class="inline-flex items-center gap-2">
                    <input type="checkbox" id="is_current" name="is_current" value="1" class="rounded border-gray-300 focus:ring-blue-500" {{ old('is_current') ? 'checked' : '' }}>
            ...
            <div>
                ...
                <input type="text" name="gpa" value="{{ old('gpa') }}" placeholder="Contoh: 3.75 atau 90/100"
                       class="block w-full rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 focus:ring-2 focus:outline-none h-11 px-3">
